...
from data_modificado import read_data ##hubo que modificarlo para que leyese nuestro script
...
def perform_experiment_2(cv_folds, epochs, batch_size, learning_rate, optimizer,
                       ...
                       show_results=False, device='/CPU:0'):
